### Enigma - zero-knowledge finance tracker

Enigma is a finance tracker built with a strong focus on privacy, and data ownership.

The core principle of this project is zero-knowledge architecture:
the server never sees, never stores, and can never reconstruct users’ financial data.
